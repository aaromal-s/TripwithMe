          ...
          <div id="reviews-list" style="display: flex; flex-direction: column; gap: 1.5rem; margin-bottom: 2rem;">
            ...
            <div class="review-card glassmorphism" style="padding: 1.5rem; display: flex; gap: 1rem; align-items: flex-start;">
              ...
              <div>
                ...
                <p style="color: var(--text-dark);">Absolutely magical experience! The heritage hotels were breathtaking and the guide was extremely knowledgeable. Highly recommend this Rajasthan tour.</p>
              </div>
            </div>
          </div>
...
with open('d:/Projects/TripwithMe/trip-details.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
if "itinerary-map" not in content:
    ...
    with open('d:/Projects/TripwithMe/trip-details.html', 'w', encoding='utf-8') as f:
        f.write(content)
    print("Map and Reviews HTML added to trip-details.html")
else:
    print("Map and Reviews already exist.")
